...
const BrotherGrid = props => {
  ...
  const [visibleBros, setVisibleBros] = useState(
    props.brothers ? props.brothers : brothers
  );
  ...
  }, [yearFilter, stateFilter, courseFilter, canFilter, props.brothers]);
      ...
      <Container>
        ...
        <div className="filters">
          <StateSelect
            ...
            stateSet={
              new Set(visibleBros.map(bro => bro.hometown.split(', ')[1]))
            }
