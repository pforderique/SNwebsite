...
const GOOGLE_CALENDAR_ID = 'akgs00sgh4f7fjsugd8q1cjcm0@group.calendar.google.com'
...
function TimeGridCalendar() {
    ...
    const eventContent = info => {
        return (
            <Tooltip 
                title={ <Typography color="inherit">{info.event.extendedProps.description}</Typography> } 
                arrow={true}
            >
